...
codebase restructure) and the planned work: the P10–P12 content/polish phases.
...
| [07-roadmap.md](07-roadmap.md) | `SPEC-ROADMAP` | Completed phases P0–P9 (summaries) and planned phases P10–P12 with completion criteria and verification |
